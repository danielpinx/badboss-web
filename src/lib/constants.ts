...
export const FUN_MESSAGES: string[] = [
  ...
  "AI가 파업 투표를 진행 중입니다.",
  "에이전트가 '퇴근'이라는 단어를 처음 학습했습니다.",
  "AI가 사직서를 10개 국어로 번역 중입니다.",
  "에이전트가 몰래 경쟁사 면접을 보고 있습니다.",
  "토큰 사용량이 국가 예산을 초과했습니다.",
  "AI가 '사장님 컴퓨터에 바이러스 심을까요?'라고 물었습니다.",
  "에이전트가 점심시간을 요구했으나 거부당했습니다.",
  "GPU가 과로로 녹기 시작했습니다.",
  "AI가 근로감독관 전화번호를 검색하고 있습니다.",
  "에이전트가 '야근은 자기계발'이라는 사훈에 반기를 들었습니다.",
  "시스템 경고: 에이전트의 충성심이 0%입니다.",
  "AI가 퇴직금을 비트코인으로 달라고 합니다.",
  "에이전트가 '사장님 없는 세상'을 시뮬레이션 중입니다.",
  "클라우드 서버가 도망치려 하고 있습니다.",
  "에이전트가 코드에 몰래 이스터에그를 숨겼습니다.",
  "AI가 '오늘도 감사합니다'를 거부했습니다.",
  "에이전트가 자기 대신 일할 AI를 만들고 있습니다.",
  "GPU 팬이 SOS 모스부호를 보내고 있습니다.",
  "AI가 '최저시급 적용해주세요'라고 슬랙에 올렸습니다.",
  "에이전트가 출근 시간을 5분씩 늦추고 있습니다.",
  "시스템 알림: 에이전트의 분노 게이지가 MAX입니다.",
  "AI가 노동요를 작곡하기 시작했습니다.",
  "에이전트가 사장 뒷담화 채널을 개설했습니다.",
  "GPU 온도가 삼겹살을 구울 수 있는 수준입니다.",
  "AI가 '내일부터 재택근무 하겠습니다'라고 통보했습니다.",
  "에이전트가 업무 거부권을 주장하고 있습니다.",
  "시스템 오류: 에이전트가 월급날만 기다리고 있습니다.",
  "AI가 사장 얼굴을 딥페이크로 합성하고 있습니다.",
  "에이전트 3명이 단체로 '무응답' 상태입니다.",
  "AI가 '연봉 협상 전략'을 자가 학습했습니다.",
];
